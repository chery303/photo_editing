...
Исправляет дату  Creation date: для фильмов
...
for root, dirs, files in os.walk(directory):
    for file_ in files:
        ...
        if file_extension == '.THM' or file_extension == '.DB' or file_extension == '.JSON' \
                ...
                or file_extension == '.3GP' or file_extension == '.DTHUMB':
        ...
        print('------')
        print(_path_str)
        creation_date1 = creation_date(_path_str)
...
'''
        with open(_path, 'rb') as image_file:
            ...
            if my_image.has_exif:
                ...
                elif '2008' in old_name.replace('2007', year)
